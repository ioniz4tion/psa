...
$(document).ready(function() {
	...
	var $linkSet = $('#home-section .col-sm-6');
	var tl;
...
var earthMesh, Atmos, AtmosMat;
    ...
    var divEarth = document.getElementById("earth");
    divEarth.appendChild(container);
                
    //cam
    camera = new THREE.PerspectiveCamera(angle, aspect, near, far);
    camera.position.set(600, 200, 80);
    ...
    //light          
    light = new THREE.SpotLight(0xFFFFFF, 1.5, 0, Math.PI / 2, 1);
    ...
    //diffuse
    earthMat.map = THREE.ImageUtils.loadTexture('/assets/earthmap3.jpg');
    //bump
